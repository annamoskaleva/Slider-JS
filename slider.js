...
function initSlider() {
    if (!images || !images.length) return;        /*что находится в слайдере*/
...
function sliderActive() {                  /*Активность Слайдера*/
...
function sliderArrow() { 
    ...
    function moveSlider(num) { /*Движение*/
